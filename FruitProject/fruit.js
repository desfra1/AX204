...
var y = 250; // small change in x- and y- direction for each frame
var r = 20;
var mx = 0;
var my = 0;
var width = 500;
...
function init(){
	...
	// Waiting for user to press keyboar
...
function drawGoodfruit(){
	...
	var good = new Image();
	good.src="good.png";
	ctx.drawImage(good,goodX,goodY,70,70);
}

// check if the ball is colliding with the goof or bad fruit

function collisionCheck () {
	// check for bad sprite collision
...
// to handle what is gonna to happen when goodCollision/badCollision is true
